...
describe("mail card buttons", () => {
  ...
  it("renders a structured calendar card without generic AI or attachment wording", () => {
    const mail: StoredMail = { ...stored(1), calendar: {
      ...
      attendees: [{ name: "Mustafa", address: "me@example.com" }], start: { raw: "20260820T103000Z", iso: "2026-08-20T10:30:00.000Z", timeZone: "UTC" }
    ...
    expect(rendered).toContain("شرکت‌کنندگان (1 نفر)");
